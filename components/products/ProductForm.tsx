    ...
    <form className="bg-[#141414] border border-yellow-500/20 rounded-2xl p-8 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="md:col-span-2">
          ...
          <input
            type="file"
            className="w-full rounded-xl bg-[#0B0B0B] border border-gray-700 px-4 py-3 text-white file:bg-yellow-500 file:text-black file:border-0 file:px-4 file:py-2 file:rounded-lg cursor-pointer"
          />
        ...
        <div className="md:col-span-2">
          ...
          <textarea
            ...
            className="w-full rounded-xl bg-[#0B0B0B] border border-gray-700 px-4 py-3 text-white resize-none focus:border-yellow-500 outline-none"
          />
