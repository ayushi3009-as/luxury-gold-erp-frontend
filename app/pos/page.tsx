              ...
              {loadingProducts ? (
                ...
                filteredProducts.map(product => (
                  ...
                  >
                    ...
                    <p className="text-xs text-text-secondary mt-1 font-mono">{product.productCode}</p>
                    <div className="flex justify-between items-center mt-3">
                      <span className="text-accent-gold font-bold">₹{product.sellingPrice?.toLocaleString()}</span>
                      <span className="text-xs px-2 py-1 bg-background-primary rounded-full border border-border-theme">
