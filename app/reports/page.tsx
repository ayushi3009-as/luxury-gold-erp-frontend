      ...
      <div className="w-full">
        ...
        <div className="bg-background-secondary border border-border-theme rounded-2xl p-6 shadow-sm">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link href="/reports/sales" className="flex items-center gap-1 text-sm text-text-secondary hover:text-accent-gold transition-colors">
                ...
                {reportsData.recentActivity.length === 0 ? (
                  ...
                  reportsData.recentActivity.map((sale: any) => (
                    <tr key={sale.invoiceNo} className="border-b border-border-theme hover:bg-background-tertiary transition-colors">
                      <td className="py-3 font-mono text-sm text-accent-gold">{sale.invoiceNo}</td>
                      <td className="py-3 font-medium">{sale.customer?.name || 'Walk-in Customer'}</td>
                      <td className="py-3 text-green-500 font-medium text-right">{formatCurrency(sale.totalAmount)}</td>
