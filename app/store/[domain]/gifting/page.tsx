  ...
  return (
    <div className="pt-32 pb-24 px-6 max-w-[1400px] mx-auto min-h-screen">
      <div className="text-center mb-24">
        ...
        <h1 className="text-5xl md:text-6xl font-serif text-text-primary mb-6">Gifting</h1>
        <p className="text-text-primary/60 max-w-2xl mx-auto font-light leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Link href="/collections" className="group relative h-[500px] overflow-hidden bg-[#111]">
          <div className="absolute inset-0 bg-background-tertiary group-hover:bg-background-tertiary transition-colors z-10 duration-700"></div>
          ...
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-6">
            <h3 className="text-4xl font-serif text-text-primary mb-4">For Her</h3>
        ...
        <Link href="/collections" className="group relative h-[500px] overflow-hidden bg-[#111]">
          ...
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center px-6">
            <h3 className="text-4xl font-serif text-text-primary mb-4">The Bridal Edit</h3>
            <span className="text-xs uppercase tracking-widest text-gold border-b border-gold pb-1">Shop Gifts</span>
          </div>
        </Link>
      </div>
