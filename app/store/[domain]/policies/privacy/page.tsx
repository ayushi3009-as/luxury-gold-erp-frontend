  ...
  return (
    <div className="pt-32 pb-24 px-6 max-w-4xl mx-auto min-h-screen">
      <div className="text-center mb-16">
        ...
        <p className="text-text-primary/60 text-lg font-light">How we protect your personal and payment information.</p>
      </div>
      <div className="border-t border-border-theme pt-12 text-text-primary/70 font-sans leading-relaxed space-y-6">
        <p>This is placeholder content for Privacy Policy. In a production environment, this page would contain the full detailed text and interactive components relevant to this section.</p>
