...
export default function CheckoutSuccessPage() {
  return (
    <div className="pt-32 pb-24 px-6 max-w-3xl mx-auto min-h-screen text-center flex flex-col items-center justify-center">
      <CheckCircle className="text-gold w-24 h-24 mb-8" strokeWidth={1} />
      <p className="text-gold uppercase tracking-[0.3em] text-xs font-semibold mb-4">Order Confirmed</p>
      ...
      <p className="text-white/60 mb-12 text-lg font-light leading-relaxed">
        Your order <span className="text-white font-medium">#TIV-89240</span> has been successfully placed. 
        You will receive an email confirmation shortly. Your bespoke piece is now being prepared for secured transit.
      </p>
      <div className="flex gap-4">
        <Link href="/account/orders/TIV-89240" className="border border-gold text-gold py-3 px-8 uppercase tracking-[0.2em] text-xs font-bold hover:bg-gold hover:text-black transition-colors duration-500 ease-luxury">
          Track Order
        </Link>
