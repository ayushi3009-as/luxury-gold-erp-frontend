...
export default function CheckoutSuccessPage() {
  return (
    <div className="pt-32 pb-24 px-6 max-w-3xl mx-auto min-h-screen text-center flex flex-col items-center justify-center">
      ...
      <h1 className="text-4xl md:text-5xl font-serif text-text-primary mb-6">Thank you for your purchase</h1>
      <p className="text-text-primary/60 mb-12 text-lg font-light leading-relaxed">
        Your order <span className="text-text-primary font-medium">#ONLINE-ORDER</span> has been successfully placed. 
      ...
      <div className="flex gap-4">
        ...
        <Link href="/" className="bg-text-primary/5 border border-border-theme text-text-primary py-3 px-8 uppercase tracking-[0.2em] text-xs font-bold hover:bg-white hover:text-black transition-colors duration-500 ease-luxury">
          Return Home
        </Link>
      </div>
    </div>
