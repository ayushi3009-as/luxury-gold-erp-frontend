  ...
  return (
    <div className="pt-32 pb-24 px-6 max-w-5xl mx-auto min-h-screen">
      ...
      <div className="text-center mb-16 relative">
        ...
        <h1 className="text-4xl md:text-6xl font-serif text-white mb-6 tracking-wide">Size Guide</h1>
          ...
          <button
            ...
            className={`flex items-center gap-2 px-8 py-4 rounded-none font-sans tracking-widest text-sm transition-all duration-300 border ${
              activeTab === tab.id
                ...
                : "border-white/20 text-white/70 hover:border-white/50 hover:text-white bg-transparent"
            }`}
          >
            {tab.icon}
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div>
                ...
                <ul className="space-y-6 text-white/70 font-sans leading-relaxed">
              ...
              <div className="bg-white/[0.02] border border-white/10 rounded-2xl p-8 flex justify-center items-center h-full">
                <div className="text-center">
                  <Circle size={64} className="text-[#D4AF37] mx-auto mb-4 opacity-50 stroke-1" />
                  <p className="text-white/50 text-sm font-sans italic">Pro Tip: Measure your fingers at the end of the day when they are at their largest.</p>
                </div>
              </div>
            </div>

            <div className="overflow-x-auto border border-white/10 rounded-xl bg-black/40">
              <table className="w-full text-left text-sm font-sans text-white/70">
                <thead className="text-[#D4AF37] bg-white/[0.02] border-b border-white/10 uppercase tracking-wider text-xs">
                  <tr>
                ...
                <tbody className="divide-y divide-white/10">
                  <tr className="hover:bg-white/[0.02] transition-colors">
                    <td className="px-6 py-4 font-bold text-white">8</td>
                  ...
                  <tr className="hover:bg-white/[0.02] transition-colors">
                    <td className="px-6 py-4 font-bold text-white">12</td>
                  ...
                  <tr className="hover:bg-white/[0.02] transition-colors">
                    <td className="px-6 py-4 font-bold text-white">16</td>
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={idx} className="border border-white/10 p-6 rounded-2xl bg-white/[0.01] hover:border-[#D4AF37]/50 transition-colors">
                  <div className="flex justify-between items-baseline mb-3">
                    <h4 className="text-xl font-serif text-white">{item.length}</h4>
                    <span className="text-[#D4AF37] font-sans text-xs tracking-widest uppercase">{item.name}</span>
                  </div>
                  <p className="text-white/60 font-sans text-sm leading-relaxed">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {activeTab === "bangles" && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="bg-white/[0.02] border border-[#D4AF37]/20 rounded-3xl p-8 md:p-12 mb-12">
              ...
              <ol className="list-decimal list-inside space-y-3 text-white/70 font-sans mb-8 marker:text-[#D4AF37]">
            ...
            <div className="overflow-x-auto border border-white/10 rounded-xl bg-black/40">
              <table className="w-full text-left text-sm font-sans text-white/70">
                ...
                <tbody className="divide-y divide-white/10">
                  <tr className="hover:bg-white/[0.02] transition-colors">
                    <td className="px-6 py-4 font-bold text-white">2-2</td>
                    <td className="px-6 py-4">2.125"</td>
                    <td className="px-6 py-4">6.67"</td>
                  </tr>
                  <tr className="hover:bg-white/[0.02] transition-colors">
                    <td className="px-6 py-4 font-bold text-white">2-4</td>
                    <td className="px-6 py-4">2.250"</td>
                    <td className="px-6 py-4">7.06"</td>
                  </tr>
                  <tr className="hover:bg-white/[0.02] transition-colors">
                    <td className="px-6 py-4 font-bold text-white">2-6</td>
                    <td className="px-6 py-4">2.375"</td>
                    <td className="px-6 py-4">7.46"</td>
                  </tr>
                  <tr className="hover:bg-white/[0.02] transition-colors">
                    <td className="px-6 py-4 font-bold text-white">2-8</td>
                    <td className="px-6 py-4">2.500"</td>
                    <td className="px-6 py-4">7.85"</td>
                  </tr>
                  <tr className="hover:bg-white/[0.02] transition-colors">
                    <td className="px-6 py-4 font-bold text-white">2-10</td>
      ...
      <div className="mt-20 text-center">
        <p className="text-white/50 text-sm font-sans mb-4">Unsure about your size?</p>
        <a href="/contact" className="text-[#D4AF37] hover:text-white transition-colors uppercase tracking-widest text-sm font-bold border-b border-[#D4AF37]/30 pb-1">
