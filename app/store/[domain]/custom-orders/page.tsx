...
export default function CustomOrdersPage() {
  ...
  return (
    <div className="pt-32 pb-24 px-6 max-w-4xl mx-auto min-h-screen text-center">
      ...
      <div className="bg-[#111]/50 border border-white/5 p-8 md:p-12 text-left relative overflow-hidden">
        {/* Glow effect */}
        ...
        {status === "success" ? (
          <div className="flex flex-col items-center justify-center py-16 animate-in fade-in zoom-in duration-500">
            ...
            <p className="text-white/70 text-center font-sans max-w-md leading-relaxed">
            ...
            <button 
              ...
              className="mt-8 border border-white/20 text-white/70 hover:text-white px-8 py-3 text-sm tracking-widest uppercase transition-colors"
            >
              Submit Another
            </button>
          </div>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-transparent border-b border-white/20 p-3 text-white focus:border-[#D4AF37] outline-none font-sans transition-colors placeholder:text-white/30" 
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full bg-transparent border-b border-white/20 p-3 text-white focus:border-[#D4AF37] outline-none resize-none font-sans transition-colors placeholder:text-white/30"
                ></textarea>
              </div>
