  ...
  return (
    <div className="text-white max-w-7xl mx-auto">
      ...
      <div className="bg-[#171717] border border-[#2C2C2C] rounded-2xl p-4 mb-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <label className="text-sm text-gray-400 font-medium">Select Customer Profile:</label>
        <select
          value={selectedCustomerId}
          onChange={(e) => setSelectedCustomerId(Number(e.target.value))}
          className="bg-[#101010] text-white border border-[#2C2C2C] rounded-xl px-4 py-2.5 outline-none focus:border-[#D4AF37] w-full sm:w-80"
        >
          {customers.map((c) => (
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
          ...
          <div className="flex-1">
            <div className="flex flex-wrap items-center gap-3">
              <h2 className="text-2xl md:text-3xl font-bold text-white">{activeCustomer.name}</h2>
              <span
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-[#171717] border border-[#2C2C2C] rounded-2xl p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-xs text-gray-400">Gold Scheme Status</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-2 bg-[#171717] border border-[#2C2C2C] rounded-2xl p-6">
          <h3 className="text-lg font-semibold text-white mb-4 border-b border-[#2C2C2C] pb-3">
            Account Details & CRM Overview
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              <p className="text-gray-400 text-xs">Customer ID</p>
              <p className="font-mono text-white font-semibold">CUST-00{activeCustomer.id}</p>
            </div>
            <div>
            ...
            <div>
              <p className="text-gray-400 text-xs">Preferred Category</p>
              <p className="text-white font-medium">22K Gold & Solitaire Diamonds</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#171717] border border-[#2C2C2C] rounded-2xl p-6 space-y-3">
          ...
          <button className="w-full text-left bg-[#101010] hover:bg-[#222] border border-[#2C2C2C] p-3 rounded-xl text-sm font-medium text-white transition">
