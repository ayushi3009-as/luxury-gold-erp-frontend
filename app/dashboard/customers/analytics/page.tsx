  ...
  return (
    <div className="text-text-primary max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-[#171717] border border-[#2C2C2C] rounded-2xl p-6">
          <div className="flex justify-between items-start mb-2">
            <span className="text-xs text-text-secondary font-medium">Customer Lifetime Value (LTV)</span>
            <div className="p-2 bg-amber-950/40 text-[#D4AF37] rounded-lg">
              <DollarSign size={18} />
            </div>
          </div>
          <h3 className="text-3xl font-bold text-text-primary">₹3.98L</h3>
          <p className="text-xs text-emerald-400 mt-2 font-medium">↑ +14.2% vs last quarter</p>
        </div>

        <div className="bg-[#171717] border border-[#2C2C2C] rounded-2xl p-6">
          <div className="flex justify-between items-start mb-2">
            <span className="text-xs text-text-secondary font-medium">Average Order Value (AOV)</span>
            <div className="p-2 bg-amber-950/40 text-[#D4AF37] rounded-lg">
              <TrendingUp size={18} />
            </div>
          </div>
          <h3 className="text-3xl font-bold text-text-primary">₹2,09,680</h3>
          <p className="text-xs text-emerald-400 mt-2 font-medium">↑ High-ticket gold jewelry sales</p>
        </div>

        <div className="bg-[#171717] border border-[#2C2C2C] rounded-2xl p-6">
          <div className="flex justify-between items-start mb-2">
            <span className="text-xs text-text-secondary font-medium">Customer Retention Rate</span>
            <div className="p-2 bg-amber-950/40 text-[#D4AF37] rounded-lg">
              <Users size={18} />
            </div>
          </div>
          <h3 className="text-3xl font-bold text-emerald-400">82.4%</h3>
          <p className="text-xs text-text-secondary mt-2">Repeat buyers in 12 months</p>
        </div>

        <div className="bg-[#171717] border border-[#2C2C2C] rounded-2xl p-6">
          <div className="flex justify-between items-start mb-2">
            <span className="text-xs text-text-secondary font-medium">Gold Scheme Opt-in Rate</span>
            <div className="p-2 bg-amber-950/40 text-[#D4AF37] rounded-lg">
              <Award size={18} />
            </div>
          </div>
          <h3 className="text-3xl font-bold text-text-primary">64.5%</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        {/* Tier Distribution */}
        <div className="bg-[#171717] border border-[#2C2C2C] rounded-2xl p-6">
          <h3 className="text-lg font-semibold text-text-primary mb-6 border-b border-[#2C2C2C] pb-3 flex items-center gap-2">
          ...
          <div className="space-y-5">
            ...
            <div>
              <div className="flex justify-between text-xs mb-1 text-text-secondary">
                ...
                <span className="font-mono text-text-secondary">312 Customers</span>
              </div>
              <div className="w-full bg-[#101010] h-3 rounded-full overflow-hidden border border-[#2C2C2C]">
        ...
        <div className="bg-[#171717] border border-[#2C2C2C] rounded-2xl p-6">
          ...
          <div className="space-y-4 text-sm">
            ...
            <div className="flex justify-between items-center p-3 bg-[#101010] rounded-xl border border-[#2C2C2C]">
              <span className="font-semibold text-text-primary">Surat</span>
              <span className="text-[#D4AF37] font-mono font-bold">₹34.5 Lakhs</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-[#101010] rounded-xl border border-[#2C2C2C]">
              <span className="font-semibold text-text-primary">Jaipur</span>
              <span className="text-[#D4AF37] font-mono font-bold">₹28.9 Lakhs</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-[#101010] rounded-xl border border-[#2C2C2C]">
              <span className="font-semibold text-text-primary">Delhi</span>
