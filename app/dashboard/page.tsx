    ...
    <main className="min-h-screen bg-[#090a09] text-white">
      <div className="flex min-h-screen">
        ...
        <section className="w-full lg:ml-[230px]">
          ...
          {/* TOPBAR */}
          <header className="flex h-[78px] items-center justify-between border-b border-[#29251a] bg-[#0b0d0c] px-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden rounded-lg border border-[#5d4818] bg-[#17150e] px-4 py-2 text-sm md:block">
                <span className="mr-2 text-[#e3b72d]">
                  🪙
                </span>

                Gold 22K:

                <span className="ml-2 font-semibold text-[#f0c43c]">
                  ₹ 7,620/g
                </span>
              </div>

              <div className="hidden items-center gap-2 rounded-lg border border-[#302b1e] bg-[#111311] px-3 py-2 md:flex">
                <Search
                  size={16}
              ...
              <div className="flex items-center gap-2 rounded-lg border border-[#44391c] px-3 py-2">
                <div className="flex h-7 w-7 items-center justify-center rounded-full bg-[#5b4820]">
                  👤
                </div>
